 ...
 * 按分类保留小数
 *
 * [MDN解决方案](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Math/round#example:_decimal_rounding)
 *
 * [stackoverflow解决方案](https://stackoverflow.com/questions/11832914/how-to-round-to-at-most-2-decimal-places-if-necessary#comment24719818_11832950)
 *
 * @param type 保留的类型
 * @param value 小数
...
function decimalAdjust(
    ...
    return +(
        valueStrArr[0] +
        'e' +
        (valueStrArr[1] ? +valueStrArr[1] + exp : exp)
    )
}
